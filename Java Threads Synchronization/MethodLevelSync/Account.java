 ...
 * 
 * Task 4: added method-level synchronization to the deposit and withdraw methods
 * This approach synchronizes the method as a WHOLE. This will ensure that only one 
 * thread can execute these methods for a given account at a time, preventing data corruption.
 *
