 ...
 * 
 * Task 5: added block-level synchronization in the deposit and withdraw methods
 * This approach only synchronizes the block of code inside the method that 
 * requires synchronization aka. THE CRITICAL SECTION allowing other parts of the 
 * method to run concurrently if they do not access shared data.
 *
 * @author Syed Ayaan Jilani (40209519) & Mateo Nieto Galindo (40192918);
 * 
 */
